...
<head>
    ...
    <script src="<%=basePath%>/js/supplier/merchant/merchantPadute.js"></script>
</head>
<body>
...
<div id="content-in">
    <div id="center">
        <form action="/supplier/supplier2/updateSupplier" method="post"  enctype="multipart/form-data">
            <table border="1">
                ...
                <tr style="height:40px;">
                    <td style="width:150px ;;background-color: #efefef">供应商名称  <input style="display: none" name="id"></td>
                    <td  style="width:300px ;">
                        <input style="width: 280px " name="name">
                    </td>
                    <td style="width:150px ;;background-color: #efefef">供应商编号</td>
                    <td>
                        <input id="" style="width: 280px " name="code">
                    </td>
                </tr>
                <tr style="height:40px;">
                ...
                <tr style="height:40px;">
                    ...
                    <td style="width:300px ;">
                        <select class="type" style="width: 200px;height: 30px " name="type">
                            <option>产品制造商</option>
                            <option>代理商</option>
                            <option >系统集成商</option>
                            <option >工程商</option>
