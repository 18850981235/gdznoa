...
<head>
    ...
    <script src="<%=basePath%>/js/mc/mcAchievement/mcAchievementPadute.js"></script>
</head>
<body>
...
<div id="content-in">
    <div id="center">
        <form  action="/mc/performanceDate/updatePerformanceDate" method="post"  enctype="multipart/form-data">
