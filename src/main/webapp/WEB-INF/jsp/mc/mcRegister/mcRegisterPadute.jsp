...
<head>
    ...
    <script src="<%=basePath%>/js/mc/mcRegister/mcRegisterPadute.js"></script>
</head>
<body>
...
<div id="content-in">
    <div id="center">
        <form action="/mc/register/updateImpl" method="post" enctype="multipart/form-data">
            <table border="1">
                ...
                <tr  style="height:40px;">
                    ...
                    <td >
                        <select class="recordsState" style="width: 100px;height:30px;margin-top: 4px  " name="recordsState" required>
                            <option value="">请选择</option>
                            <option>正常</option>
                            <option>年审</option>
                            <option>超期</option>
                    ...
                    <td style="width:300px ;">
                        <select class="caBorrow" style="width: 100px ;height:30px;margin-top: 4px  " name="caBorrow" required>
                            <option value="">请选择</option>
                            <option>借出</option>
                            <option>未借</option>
                        </select>
