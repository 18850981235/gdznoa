            ...
            <table border="1">
                <tr style="height: 40px ;background-color: #efefef">
                    <td colspan="4" style="text-align: center">
                        <b>注册备案管理修改</b><input style="display: none" name="id">
                    </td>
                </tr>
                <tr style="height:40px;">
                    <td style="width:150px ;background-color: #efefef;">注册备案名称</td>
                ...
                <tr style="height:40px;">
                    ...
                    <td colspan="3">
                        <select  style="width: 120px;height: 30px " name="recordsType">
