    ...
    <div id="center">
        <div id="query-button">
            <div class="query-top">
                ...
                <div class="top2">
                    <span>申请日期</span>
                    <input type="date" class="start" name="start">至  <input type="date" class="end" name="end">
                </div>
            </div>
            <div class="query-in">
                <div class="in1">
        ...
        <div class="paging">
            <table   style="text-align: center">
                <tr class="seal" style="height: 40px;background-color: #c4de83; ">
                    ...
                    <td style="width: 150px ">项目预算</td>
                    <td style="width: 150px ">商务部按标准核定费用</td>
