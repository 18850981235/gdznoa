...
<head>
    ...
    <script src="<%=basePath%>/js/finance/taxRevenue/indexPadute.js"></script>
</head>
<body>
<div id="content-in">
    <div id="center">
        <form action="/ga/harvestTicket/update.html" method="post"  enctype="multipart/form-data">
            <table border="1" style="width: 1000px ">
                ...
                <tr style="height:40px;">
                    ...
                    <td  style="width:300px ;">
                        <select class="type" style="width: 200px ;height: 35px " name="companyName">
                            <option>请选择</option>
                ...
                <tr style="height:40px;">
                    ...
                    <!--<td    style="width:300px ;">-->
                        <!--<select id="ap" style="width:270px ;height: 35px  " name="">-->
                ...
                <tr style="height:40px;">
                    ...
                    <td  style="width:300px ;">
                        <input style="width: 270px " name="debt">
                    </td>
                </tr>
                <tr style="height:40px;">
                ...
                <tr style="height:40px;">
                    ...
                    <td colspan="3" style="width:300px ;">
                        ...
                        <input id="inorout" style="display: none" name="inorout">
                    </td>
                </tr>
            </table>
...
<script>
    ...
    function clearMethod1() {
        var objFile=document.getElementsByTagName('input')[13];
