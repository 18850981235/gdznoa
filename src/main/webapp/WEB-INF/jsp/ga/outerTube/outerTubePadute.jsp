...
<head>
    ...
    <script src="<%=basePath%>/js/finance/outerTube/outerTubePadute.js"></script>
</head>
<body>

<div id="content-in">
    <div id="center">
        <form action="/ga/outerTube/update.html" method="post"  enctype="multipart/form-data">
            <table border="1" style="width: 1000px ">
                ...
                <tr style="height:40px;">
                    ...
                    <td colspan="3"  style="width:300px ;">
                        <textarea id="textarea" style="width: 800px ;height: 45px " name="content"></textarea>
                    </td>
