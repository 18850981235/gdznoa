...
<head>
    ...
    <script src="<%=basePath%>/js/finance/comego/indexList.js"></script>
</head>
<body>
<div id="content-in">
    <div id="center">
        ...
        <div class="paging">
            <table   style="text-align: center" >
                <tr class="seal" style="height: 40px;background-color: #c4de83; " >
                    ...
                    <td style="width: 300px ">收款单位</td>
                    <td style="width: 300px ">付款方式</td>
        ...
        <div>
            <a href="../index.html" class="add" style="height: 35px;margin-left: 600px ;line-height: 35px  ">返回</a>
        </div>
