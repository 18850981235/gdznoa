...
<head>
    ...
    <script src="<%=basePath%>/js/finance/comego/index.js"></script>
</head>
<body>
<div id="content-in">
    <div id="center">
        <form action="/ga/comego/addComeGo" method="post"  enctype="multipart/form-data">
            <table border="1" style="width: 1000px ">
                ...
                <tr style="height:40px;">
                    ...
                    <td  style="width:300px ;">
                        <select class="type1" style="width: 200px;height: 35px  " name="type">

                            <option>现金</option>
                            <option>对公</option>
                        </select>
                        <input id="ferf2" style="width: 270px;display: none " class="type" name="type2" readonly >
                    </td>
                </tr>
                <tr style="height:40px;">
