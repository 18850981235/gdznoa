...
<head>
    ...
    <script src="<%=basePath%>/js/sale/detailed/detailedList.js"></script>
    ...
    <div id="center">
        <div id="query-button">
            ...
            <div class="query-button" style="display: block">
                <a href="/sd/salesinventory/toaddPage" class="add">新增</a>
