...
<head>
    ...
    <script src="<%=basePath%>/js/sale/contract/contractAdd.js"></script>
    <base Target="_blank" />
</head>
<body>
...
<div id="content-in">
    <div id="center">
        <form  action="/sd/SdSalesContract/addContract" method="post"  enctype="multipart/form-data">
            <table border="1">
                ...
                <tr  style="height:40px;">
                    ...
                    <td style="width:300px ;">
                        <select style="height: 30px " name="invoiceType">
                            <option>请选择</option>
                            <option>普通发票</option>
                            <option>专业发票</option>
                        </select>
