    ...
    <div id="center">
        <div id="query-button">
            ...
            <div class="query-button">
                <a href="newsAdd.html" class="add">新建</a>
        ...
        <div class="paging">
            <table style="text-align: center" >
                <tr class="seal" style="height: 40px;background-color: #c4de83; " >
                    ...
                    <td style="width: 200px ">维保期限</td>
                    <td style="width: 250px ">维修记录</td>
                    <td style="width: 200px ">维修结果</td>
                    <td style="width: 150px ">维修费用</td>
