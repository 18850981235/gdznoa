...
function w() {
var  id=q("id");
var url="http://192.168.1.191:8080/bd/project/update.json?id="+id;
$.ajax({
    type:"get",
    dataType:"json",
    url:url,
    ...
    success:function (data) {
        ...
        html +='<input style="display: none" class="Eliminate-no" name="id" value='+project.principalUser.id+'>';
        ...
        html +='</td>';
        html +='<td>项目地点</td>';
        html +='<td><input style="width: 250px " name="" value='+project.abbreviation+'></td>';
        html +='</tr>';
        html +='<tr style="height: 45px ">';
        html +='<td>项目类别:</td>';
        html +='<td>';
        html +='<select  style="height: 25px " required name="biddingType"  >';
        ...
        html +='<td>预计项目投标时间：</td>';
        html +='<td>';
        html +='<input style="width: 250px " name="biddate" value='+project.biddate+' >';
        html +='</td>';
        html +='</tr>';
        html +='<tr style="height: 45px ">';
        html +='<td>项目单位名称</td>';
        ...
        html +='<input style="display: none" class="eliminate-no-2" name="id" value='+ids+'>';
        ...
        html +='<td>项目描述</td>';
        html +='<td colspan="3">';
        html +='<textarea name="content"style="width: 700px " value='+project.content+'></textarea>';
        html +='</td>';
        html +='</tr>';
        html +='<tr style="height: 45px ">';
        html +='<td>附件</td>';
