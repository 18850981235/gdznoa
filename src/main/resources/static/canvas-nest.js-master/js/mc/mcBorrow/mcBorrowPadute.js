...
function w() {
    var  id=q("id");
    var url="http://192.168.1.191:8080/mc/borrow/update.json?id="+id;
    $.ajax({
        type:"get",
        dataType:"json",
        url:url,
        ...
        success:function (data) {
         ...
         html += '<td style="width:300px ;">';
             ...
             html += '<td colspan="3"><input style="width: 700px " name="purpose" value='+data.purpose+'></td>';
             html += '</tr>';
             // html += '<tr style="height:40px;">';
             ...
             html += '<td style="width:300px ;">';
             html += '<input  style="width:280px " name="returntime" value='+data.returntime+'>';
             html += '</td>';
