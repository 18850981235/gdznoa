...
function lo(z) {
    ...
    $.ajax({
        type:"post",
        url: "/ga/harvestTicket/query.html?projectId="+projectid+"&type="+ferf,
        data:{"pageIndex":z},
        dataType:"json",
        success: function (data) {
            ...
            $.each(list, function (index1, obj1) {
                ...
                html += '<td style="width: 400px ">'+obj1.name+'</td>';
                html += '<td style="width: 300px ">'+obj1.companyName+'</td>';
                html += '<td style="width: 300px ">'+obj1.createtime+'</td>';


                html += '<td style="width:110px">';
                html += '<a href="/ga/openTicket/paricular?id='+obj1.id+'" style="color:blue">详情</a>';
                html += '<a  href="/ga/openTicket/update?id='+obj1.id+'" style="color:#dea97d; margin-left: 4px  ">编辑</a>';
                ...
                html += '<a href="" class="confirm-ok" type="submit" >' + "是" + '</a>';
