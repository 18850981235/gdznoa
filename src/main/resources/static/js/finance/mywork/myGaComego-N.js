    ...
    $.ajax({
        ...
        success:function (date) {
            ...
            if(list.processNode==1){
                html += '<input style="display:none" value="分公司总经理">';
                ...
                html += '<input style="display:none" value="公司公管领导">';
            }else if(list.processNode==5){
                html += '<input style="display:none" value="开票经办">';
            } else if(list.processNode==6){
                html += '<input style="display:none" value="出纳">';
            }
            ...
            html += '<option>分公司总经理</option>';
            html += '<option>财务经办</option>';
            html += '<option>财务主管</option>';
            html += '<option>公司公管领导</option>';
            html += '<option>开票经办</option>';
            html += '<option>出纳</option>';
