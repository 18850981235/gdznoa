...
function lo(z) {
    ...
    $.ajax({
        type: "get",
        url: "/ga/comego/query.html?projectId="+projectid+"&matter="+ferf,
        ...
        success: function (data) {
            ...
            $.each(data.list, function (index1, obj1) {
                ...
                html += '<a style="color:blue" href="/ga/comego/particular?id='+obj1.id+'">详情</a>';
                html += '<a style="color:#dea97d; margin-left: 4px " href="/ga/comego/update?id='+obj1.id+'">编辑</a>';
