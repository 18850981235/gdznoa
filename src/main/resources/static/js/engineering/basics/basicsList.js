...
function lo(z) {
    ...
    var clientid=$(".crm").val();
    var site=$(".traname").val();
    var deptid=$(".department").val();


    $.ajax({
        type:"get",
        url:"/ed/EdMassage/QuerySomeMassage",
        data:{ "projectid":projectId,"clientid":clientid,"deptid":deptid,"site":site,"pageIndex":z},
        dataType:"json",
        success: function (data) {
            ...
            $.each(list, function (index1, obj1) {
                ...
                html += '<td style="width: 200px ">'+obj1.project.abbreviation+'</td>';
                html += '<td style="width: 150px ">'+obj1.dept.name+'</td>';
                html += '<td style="width: 150px ">'+obj1.agentConstructUnit+'</td>';
                html += '<td style="width: 150px ">'+obj1.client.name+'</td>';
                html += '<td style="width: 150px ">'+obj1.supervisingUnit+'</td>';
                html += '<td style="width: 150px ">'+obj1.project.code+'</td>';
                html += '<td style="width:130px">';
                html += '<a href="/ed/EdMassage/toQueryOneMassagePage?id='+obj1.id+'" style="color:blue">详情</a>';
                html += '<a  href="/ed/EdMassage/toupdateMassagePage?id='+obj1.id+'" style="color:#dea97d; margin-left: 4px  ">编辑</a>';
                ...
                html += '<a href="/ed/EdMassage/deleteMassage" class="confirm-ok" type="submit" >' + "是" + '</a>';
