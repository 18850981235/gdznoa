...
function lo(z) {
    ...
    $.ajax({
        type:"get",
        url:"/ed/Inventory/queryContractInventory",
        ...
        success: function (data) {
            ...
            $.each(list, function (index1, obj1) {
                ...
                html += '<a href="/ed/Quantity/todetailPage?id='+obj1.id+'" style="color:blue">详情</a>';
                // html += '<a  href="/ed/Quantity/toupdatePage?id='+obj1.project.id+'" style="color:#dea97d; margin-left: 4px  ">编辑</a>';
