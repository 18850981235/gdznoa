...
function lo() {
    ...
    var recordsType=$(".recordsType").val();
    var recordsName=$(".recordsName").val();

    $.ajax({
        type: "get",
        url: "/mc/register/querybynametype.json",
        data: {"deptid":deptid,"Type":recordsType,"Name":recordsName},
        dataType: "json",
        success: function (data) {
            ...
            $.each(list, function (index1, obj1) {
                ...
                html += '<td style="width: 350px ">' + obj1.recordsName + '</td>';
                ...
                html += '<td style="width: 150px ">' + obj1.recordsType + '</td>';
                ...
                html += '<a href="/mc/register/deleteImpl" class="confirm-ok" type="submit" >' + "是" + '</a>';
