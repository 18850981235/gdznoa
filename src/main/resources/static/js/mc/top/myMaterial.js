...
function w() {
    ...
    $.ajax({
        ...
        success:function (data) {
            ...
            var list=data.list;
            html += '<input style="display: none" value='+materials.id+' name="id">';
            html += '<table border="1">';
...
// html += '<a style="float: right;color: red">'+project.processState+'</ a>';
            ...
            html += '<td style="width: 50px  ">'+materials.processNode+'<input style="display:none" value='+materials.id+' name="approvalId">';
            html += '</td>';
            ...
            }else if(materials.processNode==2){
            ...
            }else if(materials.processNode==3){
            ...
            }else if(materials.processNode==4){
            ...
            }else if(materials.processNode==5){
            ...
            html += '<td style="width: 150px  ">'+materials.processUser.name+'<input style="display:none" value='+materials.processUser.id+' name="approvalUser"></td>';
